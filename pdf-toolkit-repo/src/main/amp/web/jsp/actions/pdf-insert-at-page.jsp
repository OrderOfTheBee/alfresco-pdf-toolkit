...
<r:page titleId="title_action_pdf_insert_at_page">
	...
	<f:view>
		...
		<h:form acceptcharset="UTF-8" id="pdf-insert-action">
										...
										<tr>
											<td width="100%" valign="top"><a:errors
												...
												<table cellpadding="2" cellspacing="2" border="0"
													...
													<tr>
														<td><h:outputText
																value="#{customMsg.pdfinsert_name}:" /></td>
														<td><h:inputText
																value="#{WizardManager.bean.actionProperties.PDFInsertName}"
													...
													<tr>
														<td><h:outputText
																value="#{customMsg.pdfinsert_at_page}:" /></td>
														<td><h:inputText
																value="#{WizardManager.bean.actionProperties.PDFInsertAtPage}"
																size="50" maxlength="1024" /></td>
													</tr>
													<tr>
														<td class="paddingRow"></td>
													...
													<tr>
														<td><h:outputText
																value="#{customMsg.pdfinsert_content}:" /></td>
														<td><r:contentSelector id="content-picker"
																value="#{WizardManager.bean.actionProperties.PDFInsertContent}" /></td>
													</tr>
													<tr>
														<td class="paddingRow"></td>
													</tr>
